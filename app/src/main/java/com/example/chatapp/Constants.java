    ...
    public static HashMap<String, String> getRemoteMsgHeader() {
        if (remoteMsgHeader == null) {
            ...
            remoteMsgHeader.put(
                    ...
                    "key=AAAAF4XtNi8:APA91bFswiF1s2pwMS5IBPI1uB60sTGCFN3kWZyiRzj7roLeNXpZgBcajFq0hRTP_l0toQRYGHmJxTSuWLVfuoZhXq1Arh7xQEaNjQQAEQPZ4V6RLX0a-_ws8dnMvrZEejbJvKljKI6e"
            );
            remoteMsgHeader.put(
